                  ...
                  Expanded(
                    child: InkWell(onTap: (){
                      ...
                      Navigator.of(context).pop();
                        ...
                        child:  Icon(CupertinoIcons.camera_fill, size: 75, color: Theme.of(context).primaryColor,)),
                  ),
                  Expanded(
                    child: InkWell(onTap: (){
                      Get.find<OrderController>().gotoEndOfPage();
                      ...
                      Navigator.of(context).pop();
                        ...
                        child: Icon(CupertinoIcons.photo_fill,  size: 75, color: Theme.of(context).primaryColor)),
                  ),
